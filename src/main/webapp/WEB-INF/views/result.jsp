...
<script src="/js/chartdounat.js"></script>
...
<body>
	...
	<div id="wrap">
		...
		<div class="search-bar">
			...
			<div class="inner">
				<form id="searchForm2" class="searchBox-input">
					<div class="searchBox">
						<input type="text" id="fullgameName" name="fullgameName"
							class="nameInfo" placeholder="소환사 이름 + KRI" required />
		...
		<div class="summonerInfo">
			<div class="inner">
				<p>
					Game Name: <span id="gameNameDisplay">${param.gameName}</span>
				</p>
				<p>
					Tag Line: <span id="tagLineDisplay">${param.tagLine}</span>
				</p>
				<button type="button" id="updateButton">
					<span class="material-symbols-outlined">refresh</span>&nbsp;전적 갱신
				</button>
		...
		<div class="search-result">
			...
			<div class="inner" id="wrap">
				<h3>test</h3>
				<canvas id="myChartdounat"></canvas>
				<canvas id="myChartbar"></canvas>
				<table align="center" border="1" width="800">
					<tr>
						<td>
							<div>
								<table id="additionalTable" align="center" border="1"
									width="200">
									<tr>
