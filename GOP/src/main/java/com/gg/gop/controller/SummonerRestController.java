...
public class SummonerRestController {
	...
	public List<Map> summonerSearch(SummonerDto gameName, SummonerDto tagLine) {
	...
	public List<Map> summonerUpdate(SummonerDto gameName, SummonerDto tagLine) {
